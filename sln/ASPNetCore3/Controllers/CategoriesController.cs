...
namespace ASPNetCore3.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Note,CategoryTypeId,Id,CreatedOn,LastModifiedOn,CreatedBy,LastModifiedBy")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Name,Note,CategoryTypeId,Id,CreatedOn,LastModifiedOn,CreatedBy,LastModifiedBy")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
